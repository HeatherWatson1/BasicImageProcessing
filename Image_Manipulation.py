...
#Replace noise with Average of neighboring pixel values 3x3
def AverageBasedNoiseReduction(im, pixels):
...
#Replace noise with Median of neighboring pixel values
def MedianNoiseReduction(im, pixels):
    ...
    for i in range(len(pixels)):
        ...
        if (i % 2) == 0:
            ...
            if x == 0 and y == 0:
                ...
                list = [CenterValue, one, two, three]
                
                #sort list and set value 
                ascend = sorted(list)
                index = round(len(ascend) / 2)
                
                Med = ascend[index]
                im.putpixel((x,y),(Med, Med, Med))
            ...
            #Handle Left Side
                ...
                #Find the Median value
                list = [CenterValue, one, two, three, four, five]
            ...
            #All non edge values.
                ...
                #Find the Median value
                list = [CenterValue, one, two, three, four, five, six, seven, eight]
...
#markNoise(noise,im)
#AverageBasedNoiseReduction(im, noise)
MedianNoiseReduction(im, noise)
